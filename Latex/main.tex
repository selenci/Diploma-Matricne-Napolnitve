...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\def\Title{\ttitle}
\def\Author{\tauthor, mk2529@student.uni-lj.si}
\def\Subject{\ttitleEn}
...
\pdfinfo{%
    /Title    (\ttitle)
    /Author   (\tauthor, mk2529@student.uni-lj.si)
    /Subject  (\ttitleEn)
    /Keywords (\tkeywordsEn)
...
\noindent\textbf{Naslov:} Algoritmi za reševanje problema matričnih napolnitev\\
...
Primerjajte algoritme glede na kakovost napolnitve, časovno zahtevnost in pojasnite ugotovitve z uporabo teoretičnega ozadja algoritmov. Na koncu predlagajte možne nadaljnje izboljšave.
...
\noindent 
    ...
    We analyze different aspects of reconstructions and interpret the results 
    referring to the mathematical background of the algorithms. We also compare the results with a more standard method of image reconstruction, based on solving the Laplace differential equations.
\bigskip
