...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Napake algoritmov izračunane v Frobeniusovi normi. \CG{Kratica OZP stoji za odstotek znanih podatkov}}
\end{table}
\begin{figure}[!ht]
    \centering
...
\section{Primerjava rezultatov z algoritmom za reševanje Poissonovih enačb} \label{1307-2255}
