...
\CG{
Razdelek \ref{2607-1502} predstavi definicije in oznake, ki se čez celotno poglavje pojavljajo. Razdelek \ref{1707-1755} na kratko predstavi algoritem minimizacije nuklearne norme (NNM), ter predstavi, kako problem pretvorimo v problem semidefinitnega programiranja.
Razdelek \ref{2807-1441} opiše algoritem praga singularnih vrednosti (SVT), ter predstavi idejo za algoritmom. 
V razdelku \ref{2807-1442} predstavimo algoritem minimizacije prirezane nuklearne norme (TNNM), ter algoritem ADMM, ki ga algoritem TNNM uporablja.
Razdelek \ref{2707-1337} opisuje, kako algoritem izmenjujočega gradientnega spusta (ASD) uporablja gradient in optimalni korak za iskanje primerne rešitve.
V razdelku \ref{2807-1447} pa opišemo algoritem LMaFit, ki za svoje delovanje uporablja Moore-Penroseov inverz. 
}
\section{Definicije in oznake} \label{2607-1502}
...
\begin{enumerate}
  ...
  \item \textbf{Nuklearna norma} matrike $A\in \mathbb R^{n_1\times n_2}$ je definirana kot \[
        ...
        %https://angms.science/doc/LA/KyFanNorm.pdf
        \CG{Dokaz, zakaj nuklearna norma upošteva potrebne pogoje norme je opisan v \cite[teorem 5.6.18]{matrixAnalysis}. Definicija $\norm{\cdot}_1$ je ekvivalentna nuklearni normi.}
