...
\CR{Še pri stilu trditve bo potrebno poenotiti označevanje, tako kot pri izrekih. To lahko na koncu dorečeva, saj se samo spremeni v preambuli.}
...
\CG{Tega smo definirali v razdelku \ref{2607-1502}.} \CR{
...
\end{align*} \todo{$U_0(\Sigma_0 - \Sigma_0 + \tau I)V_0^T$}
in 
\begin{align*}
