...
\begin{proof}
\CG{Pri tem dokazu} nam bo prav prišla \CR{definicija} $\delta_{i, j}$, definirana kot
\[
    \delta_{i,j} = 
    \left\{
    \begin{array}{rl}
