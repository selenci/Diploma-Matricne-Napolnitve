...
Dokazano je bilo \cite{NNM-PHD}, da nuklearna norma predstavlja konveksno ovojnico funkcije ranga. \todo{poglej razliko convex hull in lower envelope} \CG{\textbf{Konveksna ovojnica funkcije} $f : \mathbb{R}^{n_1 \times n_2} \rightarrow \mathbb{R}$ je definirana kot \[
    \tilde{f}(x) = \sup\{g(x) \mid g \text{ je konveksna in } \forall x: g(x) \leq f(x) \}.
\]}
...
\begin{align*}
    ...
    \text{pri pogojih} \hspace{0.5cm} & \nnorm{X} \leq t, \numberthis \label{1007-1830} \\
                                      & \proj(X) = \proj(M),
\end{align*}
\CG{kjer je $M \in \mathbb{R}^{n_1 \times n_2}$ zašumljena matrika, $\Omega$ pa množica urejenih parov, ki predstavljajo mesta, kjer vrednosti matrike poznamo.}
